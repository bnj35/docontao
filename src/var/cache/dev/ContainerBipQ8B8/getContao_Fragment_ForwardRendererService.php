 ...
 */
class getContao_Fragment_ForwardRendererService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/contao/core-bundle/src/Fragment/ForwardFragmentRenderer.php';
