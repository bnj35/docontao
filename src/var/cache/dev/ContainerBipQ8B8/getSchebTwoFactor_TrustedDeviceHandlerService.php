 ...
 */
class getSchebTwoFactor_TrustedDeviceHandlerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return new \Scheb\TwoFactorBundle\Security\TwoFactor\Handler\TrustedDeviceHandler($container->load('getSchebTwoFactor_ProviderHandlerService'), ($container->privates['scheb_two_factor.default_trusted_device_manager'] ?? $container->load('getSchebTwoFactor_DefaultTrustedDeviceManagerService')), false);
    }
}
