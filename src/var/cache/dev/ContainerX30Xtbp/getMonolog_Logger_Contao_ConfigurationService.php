 ...
 */
class getMonolog_Logger_Contao_ConfigurationService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = new \Symfony\Bridge\Monolog\Logger('contao.configuration');
