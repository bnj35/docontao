 ...
 */
class getMonolog_Logger_Contao_EmailService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = new \Symfony\Bridge\Monolog\Logger('contao.email');
        ...
        return $container->services['monolog.logger.contao.email'] = new \Contao\CoreBundle\Monolog\SystemLogger($a, 'EMAIL');
    }
}
