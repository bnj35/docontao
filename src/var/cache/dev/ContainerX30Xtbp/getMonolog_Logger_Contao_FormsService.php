 ...
 */
class getMonolog_Logger_Contao_FormsService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
     * Gets the public 'monolog.logger.contao.forms' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = new \Symfony\Bridge\Monolog\Logger('contao.forms');
        ...
        return $container->services['monolog.logger.contao.forms'] = new \Contao\CoreBundle\Monolog\SystemLogger($a, 'FORMS');
    }
}
