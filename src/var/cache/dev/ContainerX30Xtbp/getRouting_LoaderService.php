 ...
 */
class getRouting_LoaderService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addLoader(new \Contao\CoreBundle\Routing\ImagesLoader(\dirname(__DIR__, 4), (\dirname(__DIR__, 4).'/assets/images')));
        $a->addLoader(($container->privates['contao.routing.frontend_loader'] ?? ($container->privates['contao.routing.frontend_loader'] = new \Contao\CoreBundle\Routing\FrontendLoader(false, '.html'))));
        $a->addLoader($c);
