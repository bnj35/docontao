...
class getSecurity_Authentication_Rememberme_Services_Simplehash_ContaoFrontend_TwoFactorDecoratorService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authentication.rememberme.services.simplehash.contao_frontend.two_factor_decorator'] = new \Scheb\TwoFactorBundle\Security\Authentication\RememberMe\RememberMeServicesDecorator(new \Contao\CoreBundle\Security\Authentication\RememberMe\ExpiringTokenBasedRememberMeServices(($container->privates['contao.repository.remember_me'] ?? $container->load('getContao_Repository_RememberMeService')), new RewindableGenerator(function () use ($container) {
