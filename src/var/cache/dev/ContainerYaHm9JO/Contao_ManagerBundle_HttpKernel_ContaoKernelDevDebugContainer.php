...
class Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer extends Container
{
    ...
    protected function getAssets_PackagesService()
    {
        ...
        $d = new \Symfony\Component\Asset\PathPackage('assets/ace', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.33.0', '%s?v=%s'), $c);
        ...
        $f = new \Symfony\Component\Asset\PathPackage('assets/colorbox', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.6.6', '%s?v=%s'), $c);
        ...
        $h = new \Symfony\Component\Asset\PathPackage('assets/contao', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('9.3.5', '%s?v=%s'), $c);
        ...
        $m = new \Symfony\Component\Asset\PathPackage('assets/mediabox', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.5.5', '%s?v=%s'), $c);
        $n = new \Symfony\Component\Asset\PathPackage('assets/mootools', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.6.0.7', '%s?v=%s'), $c);
        ...
        $p = new \Symfony\Component\Asset\PathPackage('assets/swipe', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.2.1', '%s?v=%s'), $c);
        $q = new \Symfony\Component\Asset\PathPackage('assets/tablesort', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('4.0.1', '%s?v=%s'), $c);
        $r = new \Symfony\Component\Asset\PathPackage('assets/tablesorter', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.31.3', '%s?v=%s'), $c);
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('aDH5oEBQyd', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types'], new \Doctrine\DBAL\Tools\DsnParser(['db2' => 'ibm_db2', 'mssql' => 'pdo_sqlsrv', 'mysql' => 'pdo_mysql', 'mysql2' => 'pdo_mysql', 'postgres' => 'pdo_pgsql', 'postgresql' => 'pdo_pgsql', 'pgsql' => 'pdo_pgsql', 'sqlite' => 'pdo_sqlite', 'sqlite3' => 'pdo_sqlite'])))->createConnection(['driver' => 'pdo_mysql', 'url' => $this->getEnv('DATABASE_URL'), 'charset' => 'utf8mb4', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [1002 => 'SET SESSION sql_mode=CONCAT(@@sql_mode, IF(INSTR(@@sql_mode, \'STRICT_\'), \'\', \',TRADITIONAL\'))'], 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collation' => 'utf8mb4_unicode_ci', 'engine' => 'InnoDB', 'row_format' => 'DYNAMIC', 'collate' => 'utf8mb4_unicode_ci']], $b, $a, []);
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Br-dud7NlB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GIZZPrEUI1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+WejMlXBZP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('p7431TM-5i', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fwiyPDCXJT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('m-Mjd6SDCK', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8lHADtArVr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.packages' => [
                ...
                'contao-components/swipe' => '2.2.1',
                'contao-components/tablesort' => '4.0.1',
                'contao-components/tablesorter' => '2.31.3',
                'contao-components/tinymce4' => '5.10.9',
                'contao/calendar-bundle' => '4.13.43',
                'contao/comments-bundle' => '4.13.43',
                'contao/conflicts' => 'dev-main',
                'contao/core-bundle' => '4.13.43',
                'contao/faq-bundle' => '4.13.43',
                'contao/image' => '1.2.0',
                'contao/imagine-svg' => '1.0.3',
                'contao/installation-bundle' => '4.13.43',
                'contao/listing-bundle' => '4.13.43',
                'contao/manager-bundle' => '4.13.43',
                'contao/manager-plugin' => '2.13.1',
                'contao/news-bundle' => '4.13.43',
                'contao/newsletter-bundle' => '4.13.43',
                'dasprid/enum' => '1.0.5',
                ...
                'friendsofsymfony/http-cache' => '2.15.3',
                'friendsofsymfony/http-cache-bundle' => '2.17.0',
                'imagine/imagine' => '1.3.5',
                'knplabs/knp-menu' => '3.5.0',
                ...
                'symfony/framework-bundle' => '5.4.38',
                'symfony/http-client' => '5.4.38',
                'symfony/http-client-contracts' => '2.5.3',
                'symfony/http-foundation' => '5.4.38',
                'symfony/http-kernel' => '5.4.38',
                'symfony/intl' => '5.4.35',
                'symfony/lock' => '5.4.38',
                'symfony/mailer' => '5.4.38',
                'symfony/mime' => '5.4.38',
                ...
                'symfony/property-access' => '5.4.38',
                'symfony/property-info' => '6.4.6',
                'symfony/routing' => '5.4.38',
                'symfony/security-bundle' => '5.4.38',
                'symfony/security-core' => '5.4.38',
                'symfony/security-csrf' => '5.4.35',
                'symfony/security-guard' => '5.4.35',
                'symfony/security-http' => '5.4.38',
                'symfony/service-contracts' => '2.5.3',
                'symfony/stopwatch' => '5.4.35',
                'symfony/string' => '5.4.36',
                'symfony/templating' => '6.4.3',
                'symfony/translation' => '5.4.35',
                'symfony/translation-contracts' => '2.5.3',
                'symfony/twig-bridge' => '5.4.38',
            ...
            'contao.resources_paths' => [
                ...
                4 => (\dirname(__DIR__, 4).'/vendor/contao/news-bundle/src/Resources/contao'),
                5 => (\dirname(__DIR__, 4).'/vendor/contao/listing-bundle/src/Resources/contao'),
                6 => (\dirname(__DIR__, 4).'/vendor/contao/calendar-bundle/src/Resources/contao'),
                7 => (\dirname(__DIR__, 4).'/vendor/contao/newsletter-bundle/src/Resources/contao'),
            ],
            'console.command.ids' => [
