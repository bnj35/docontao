 ...
 */
class getRootPageControllerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/vendor/contao/core-bundle/src/Controller/Page/RootPageController.php';
