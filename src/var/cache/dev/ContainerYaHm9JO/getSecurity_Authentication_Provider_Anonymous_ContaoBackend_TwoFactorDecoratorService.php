 ...
 */
class getSecurity_Authentication_Provider_Anonymous_ContaoBackend_TwoFactorDecoratorService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
     * Gets the private 'security.authentication.provider.anonymous.contao_backend.two_factor_decorator' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authentication.provider.anonymous.contao_backend.two_factor_decorator'])) {
            return $container->privates['security.authentication.provider.anonymous.contao_backend.two_factor_decorator'];
        }

        return $container->privates['security.authentication.provider.anonymous.contao_backend.two_factor_decorator'] = new \Scheb\TwoFactorBundle\Security\Authentication\Provider\AuthenticationProviderDecorator($container->load('getSecurity_Authentication_Provider_Anonymous_ContaoBackend_TwoFactorDecorator_InnerService'), ($container->privates['scheb_two_factor.condition_handler'] ?? $container->load('getSchebTwoFactor_ConditionHandlerService')), ($container->privates['scheb_two_factor.authentication_context_factory'] ?? ($container->privates['scheb_two_factor.authentication_context_factory'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\AuthenticationContextFactory('Scheb\\TwoFactorBundle\\Security\\TwoFactor\\AuthenticationContext'))), $a, ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())));
    }
}
