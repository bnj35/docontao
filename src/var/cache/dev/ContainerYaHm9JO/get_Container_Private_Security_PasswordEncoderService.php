 ...
 */
class get_Container_Private_Security_PasswordEncoderService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['.container.private.security.password_encoder'] = new \Symfony\Component\Security\Core\Encoder\UserPasswordEncoder(($container->services['.container.private.security.encoder_factory'] ?? $container->load('get_Container_Private_Security_EncoderFactoryService')));
    }
}
