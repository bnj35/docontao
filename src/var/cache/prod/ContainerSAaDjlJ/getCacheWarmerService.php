 ...
 */
class getCacheWarmerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 7 => ($container->privates['contao.twig.filesystem_loader_warmer'] ?? $container->load('getContao_Twig_FilesystemLoaderWarmerService'));
        }, 8), false, ($container->targetDir.''.'/Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainerDeprecations.log'));
    }
}
