 ...
 */
class getFosHttpCache_Command_ClearService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['fos_http_cache.command.clear'] = $instance = new \FOS\HttpCacheBundle\Command\ClearCommand(($container->services['fos_http_cache.cache_manager'] ?? $container->getFosHttpCache_CacheManagerService()));
