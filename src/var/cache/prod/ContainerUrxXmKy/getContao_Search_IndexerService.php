 ...
 */
class getContao_Search_IndexerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addIndexer(new \Contao\CoreBundle\Search\Indexer\DefaultIndexer(($container->services['contao.framework'] ?? $container->getContao_FrameworkService()), ($container->services['doctrine.dbal.default_connection'] ?? $container->getDoctrine_Dbal_DefaultConnectionService()), false));
