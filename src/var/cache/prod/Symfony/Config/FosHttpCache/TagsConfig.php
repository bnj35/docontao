...
class TagsConfig 
{
     ...
     * @return $this
     */
    public function strict($value): self
    {
    ...
    /**
     * Service name of a custom ExpressionLanugage to use.
     * @default null
     ...
     * @return $this
     */
    public function responseHeader($value): self
    {
     ...
     * @return $this
     */
    public function maxHeaderValueLength($value): self
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('rules', $value)) {
            $this->_usedProperties['rules'] = true;
            $this->rules = array_map(function ($v) { return new \Symfony\Config\FosHttpCache\Tags\RuleConfig($v); }, $value['rules']);
            unset($value['rules']);
        }
