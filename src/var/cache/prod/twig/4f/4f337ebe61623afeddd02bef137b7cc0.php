...
class __TwigTemplate_7c462049e7cf6174705a170ab844b2f4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <p class=\"tl_error\">";
        // line 7
        yield $this->env->getFilter('escape')->getCallable()($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("old_database", [], "ContaoInstallationBundle"), "contao_html", null, true);
        yield "</p>
    <p>";
        // line 8
        yield $this->env->getFilter('escape')->getCallable()($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("old_database_explanation", [], "ContaoInstallationBundle"), "contao_html", null, true);
        yield "</p>
  </fieldset>
";
        return; yield '';
