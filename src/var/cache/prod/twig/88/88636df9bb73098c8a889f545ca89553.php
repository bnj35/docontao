...
class __TwigTemplate_d873076d22d10919b1202e208420f406 extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            <div class=\"tl_formbody\">
              ...
              ";
                ...
                yield $this->env->getFilter('escape')->getCallable()($this->env, ((array_key_exists("admin_username_value", $context)) ? (Twig\Extension\CoreExtension::defaultFilter(($context["admin_username_value"] ?? null))) : ("")), "contao_html", null, true);
                yield "\" required>
              <h4><label for=\"name\">";
                // line 122
              ...
              <input type=\"text\" name=\"name\" id=\"name\" class=\"tl_text\" value=\"";
                // line 123
                yield $this->env->getFilter('escape')->getCallable()($this->env, ((array_key_exists("admin_name_value", $context)) ? (Twig\Extension\CoreExtension::defaultFilter(($context["admin_name_value"] ?? null))) : ("")), "contao_html", null, true);
                yield "\" required>
              <h4><label for=\"email\">";
                // line 124
              ...
              ";
                ...
                yield $this->env->getFilter('escape')->getCallable()($this->env, ((array_key_exists("admin_email_value", $context)) ? (Twig\Extension\CoreExtension::defaultFilter(($context["admin_email_value"] ?? null))) : ("")), "contao_html", null, true);
                yield "\" required>
              ...
              ";
                ...
                yield $this->env->getFilter('escape')->getCallable()($this->env, ((array_key_exists("admin_password_value", $context)) ? (Twig\Extension\CoreExtension::defaultFilter(($context["admin_password_value"] ?? null))) : ("")), "contao_html", null, true);
                yield "\" required>
            </div>
            <div class=\"tl_formbody_submit\">
              <div class=\"tl_submit_container\">
