...
class __TwigTemplate_0d5319f2cb202a2810d29c07d49160b1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <p class=\"tl_error\">";
        // line 7
        echo $this->env->getFilter('escape')->getCallable()($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("locked_headline", [], "ContaoInstallationBundle"), "contao_html", null, true);
        echo "</p>
    <p>";
        // line 8
