...
class __TwigTemplate_362bba999f49e11845750624dee25b9d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 13
        $context["modified"] = Twig\Extension\CoreExtension::arrayFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["change_set"] ?? null), "itemsToUpdate", [], "any", false, false, false, 13), function ($__item__) use ($context, $macros) { $context["item"] = $__item__; return CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "updatesHash", [], "any", false, false, false, 13); });
        // line 14
        yield "    ";
        $context["moved"] = Twig\Extension\CoreExtension::arrayFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["change_set"] ?? null), "itemsToUpdate", [], "any", false, false, false, 14), function ($__item__) use ($context, $macros) { $context["item"] = $__item__; return CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "updatesPath", [], "any", false, false, false, 14); });
        // line 15
        yield "
    <p>";
        // line 16
        yield $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("tl_files.syncResult", [Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["change_set"] ?? null), "itemsToCreate", [], "any", false, false, false, 16)), Twig\Extension\CoreExtension::lengthFilter($this->env, ($context["modified"] ?? null)), "-", Twig\Extension\CoreExtension::lengthFilter($this->env, ($context["moved"] ?? null)), Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["change_set"] ?? null), "itemsToDelete", [], "any", false, false, false, 16))], "contao_tl_files");
        yield "</p>
