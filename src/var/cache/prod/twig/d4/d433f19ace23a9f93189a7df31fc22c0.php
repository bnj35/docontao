...
class __TwigTemplate_f0d8a41565caf22067d9b81d80da2b3c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        $macros = $this->macros;
        echo $this->env->getFilter('escape')->getCallable()($this->env, ($context["statusCode"] ?? null), "contao_html", null, true);
        echo " Error";
    }
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        if (        $this->hasBlock("howToFix", $context, $blocks)) {
            ...
            if ( !twig_test_empty(twig_trim_filter(($context["_block"] ?? null)))) {
                // line 142
                echo "                                        <h2>";
                echo $this->env->getFilter('escape')->getCallable()($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("XPT.howToFix", [], "contao_exception"), "contao_html", null, true);
                echo "</h2>
                                        ";
                // line 143
                echo ($context["_block"] ?? null);
        ...
        if (        $this->hasBlock("explain", $context, $blocks)) {
            ...
            if ( !twig_test_empty(twig_trim_filter(($context["_block"] ?? null)))) {
                // line 149
                echo "                                        <h3>";
                echo $this->env->getFilter('escape')->getCallable()($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("XPT.more", [], "contao_exception"), "contao_html", null, true);
                echo "</h3>
                                        ";
                // line 150
                echo ($context["_block"] ?? null);
    ...
    {
        $macros = $this->macros;
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("XPT.hint", [($context["template"] ?? null)], "contao_exception");
    }
    ...
    {
        return array (  319 => 162,  315 => 153,  312 => 152,  307 => 150,  302 => 149,  299 => 148,  296 => 147,  293 => 146,  290 => 145,  285 => 143,  280 => 142,  277 => 141,  274 => 140,  271 => 139,  268 => 138,  263 => 136,  258 => 135,  255 => 134,  252 => 133,  249 => 132,  245 => 131,  236 => 127,  135 => 12,  131 => 11,  123 => 7,  119 => 110,  117 => 11,  113 => 10,  107 => 7,  104 => 6,  100 => 5,  92 => 163,  90 => 162,  80 => 154,  78 => 131,  73 => 128,  71 => 127,  53 => 111,  51 => 5,  46 => 3,  43 => 2,);
    }

    public function getSourceContext()
    {
        return new Source("", "@ContaoCore/Error/layout.html.twig", "/var/www/html/vendor/contao/core-bundle/src/Resources/views/Error/layout.html.twig");
    }
}
