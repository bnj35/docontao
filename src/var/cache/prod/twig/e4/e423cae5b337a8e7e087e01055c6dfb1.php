...
class __TwigTemplate_9cab9b676a01340e823650bc0a82e5d3 extends Template
{
    private $source;
    private $macros = [];
...
<script>
    (function () {
        ...
        // line 344
        echo $this->env->getFilter('escape')->getCallable()($this->env, $this->env->getFilter('escape')->getCallable()($this->env, ($context["preview_script"] ?? null), "js"), "contao_html", null, true);
        echo "', '');
...
";
    ...
    {
        return array (  385 => 344,  282 => 244,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@ContaoCore/Frontend/preview_toolbar_base_js.html.twig", "/var/www/html/vendor/contao/core-bundle/src/Resources/views/Frontend/preview_toolbar_base_js.html.twig");
    }
}
