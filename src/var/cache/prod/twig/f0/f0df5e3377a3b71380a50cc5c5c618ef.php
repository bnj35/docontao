...
class __TwigTemplate_62ced9f9566d3ec66eeb27702dc29d3e extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
      ...
      <form method=\"post\">
        ...
        // line 17
        yield $this->env->getFilter('escape')->getCallable()($this->env, ((CoreExtension::getAttribute($this->env, $this->source, ($context["parameters"] ?? null), "database_host", [], "any", true, true, false, 17)) ? (Twig\Extension\CoreExtension::defaultFilter(CoreExtension::getAttribute($this->env, $this->source, ($context["parameters"] ?? null), "database_host", [], "any", false, false, false, 17), "localhost")) : ("localhost")), "contao_html", null, true);
        yield "\">
          <h4><label for=\"dbPort\">";
        // line 18
        ...
        // line 19
        yield $this->env->getFilter('escape')->getCallable()($this->env, ((CoreExtension::getAttribute($this->env, $this->source, ($context["parameters"] ?? null), "database_port", [], "any", true, true, false, 19)) ? (Twig\Extension\CoreExtension::defaultFilter(CoreExtension::getAttribute($this->env, $this->source, ($context["parameters"] ?? null), "database_port", [], "any", false, false, false, 19), 3306)) : (3306)), "contao_html", null, true);
        yield "\">
          <h4><label for=\"dbUser\">";
        // line 20
        ...
        // line 25
        yield $this->env->getFilter('escape')->getCallable()($this->env, ((CoreExtension::getAttribute($this->env, $this->source, ($context["parameters"] ?? null), "database_name", [], "any", true, true, false, 25)) ? (Twig\Extension\CoreExtension::defaultFilter(CoreExtension::getAttribute($this->env, $this->source, ($context["parameters"] ?? null), "database_name", [], "any", false, false, false, 25), "")) : ("")), "contao_html", null, true);
        yield "\">
        </div>
